<?php
class FluidCache_Standalone_partial_Action_Common_SubmitButton_049f4b5c0f3e1eb464f19ca12c235618a282055a extends \TYPO3\CMS\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '<button class="btn btn-default ';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments1 = array();
$arguments1['value'] = $currentVariableContainer->getOrNull('className');
...
$output0 .= '</button>
<input type="hidden" name="install[set][';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments7 = array();
$arguments7['value'] = $currentVariableContainer->getOrNull('name');
